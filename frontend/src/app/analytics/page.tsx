        ...
        <div className="flex items-center justify-between">
          ...
          {connected && (
            <div className="flex items-center gap-2">
              <button
                onClick={() => void refreshWithTimestamp()}
                disabled={loading}
                title="Refresh analytics"
                className="p-1.5 rounded-lg text-gray-400 hover:text-brand-500 disabled:opacity-40 transition-colors"
              >
                <svg
              ...
              {!loading && <AnalyticsExportButton vaults={vaults} currentBlock={currentBlock} />}
            </div>
          )}
        </div>
