...
export const VaultSearchBar = forwardRef<HTMLInputElement, VaultSearchBarProps>(
  function VaultSearchBar({ query, onQueryChange }, ref) {
    return (
      <div className="relative mb-3">
        ...
        <input
          ...
          placeholder='Search vaults… (press "/" to focus)'
